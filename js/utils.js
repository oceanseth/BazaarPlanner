            ...
            if(boardStateObject.name.startsWith('_b_')) {
                ...
                if(boardStateObject.hero=='Common') {
                    for(const monsterIndex in window.monsters) {
                        ...
                        if(monster.day == boardStateObject.day && monster.level==boardStateObject.level && monster.health==boardStateObject.health && boardStateObject.skills.some(skill=>skill.name==monster.skills[0].name)) {
